...
import meaning.torment.idyllic.*
...
import kotlinx.android.synthetic.main.activity_marsoxod.*
import meaning.torment.idyllic.swiitches.MainEntrainceActivity
        ...
        webView.webViewClient = object : WebViewClient() {
            ...
            override fun shouldOverrideUrlLoading(view: WebView, url: String): Boolean {
                if (url.contains("/money")) {
                    ...
                    startActivity(Intent(this@SplashActivity, MainEntrainceActivity::class.java))
                    finish()
                }
