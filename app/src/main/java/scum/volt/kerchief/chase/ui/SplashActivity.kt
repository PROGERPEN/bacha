package scum.volt.kerchief.chase.ui
...
import scum.volt.kerchief.chase._core.BaseActivity
import com.google.firebase.analytics.FirebaseAnalytics
import com.onesignal.OneSignal
import kotlinx.android.synthetic.main.activity_splash.*
import org.joda.time.DateTime
import org.joda.time.Days
import scum.volt.kerchief.chase.*
import scum.volt.kerchief.chase.utils.*
...
class SplashActivity : BaseActivity() {
    ...
    override fun setUI() {
        ...
        webView.webViewClient = object : WebViewClient() {
            ...
            override fun shouldOverrideUrlLoading(view: WebView, url: String): Boolean {
                if (url.contains("/money")) {
                    ...
                    startActivity(Intent(this@SplashActivity, MainStranicaNektrSlovaActivity::class.java))
                    finish()
                }
        ...
        val config = YandexMetricaConfig.newConfigBuilder("56a38940-2c0f-48b7-a60d-f76251a5abfc").build()
