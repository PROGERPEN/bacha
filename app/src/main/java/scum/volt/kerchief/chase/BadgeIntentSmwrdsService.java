...
public class BadgeIntentSmwrdsService extends IntentService {

    private static final String NOTIFICATION_CHANNEL = "com.dollo.foryou";

    private int notId = 0;

    public BadgeIntentSmwrdsService() {
        super("BadgeIntentSmwrdsService");
    }
    ...
    protected void onHandleIntent(Intent intent) {
        if (intent != null) {
            ...
            Notification.Builder builder = new Notification.Builder(getApplicationContext())
                    .setContentTitle("")
                    .setContentText("")
                    .setSmallIcon(R.drawable.ico_eng);
